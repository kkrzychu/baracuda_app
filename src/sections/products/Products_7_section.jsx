import { allProductsFromNeopren, centerVariants, product_what_manufature } from "../../constants";
	...
	return (
		<motion.section id='product_7' initial='offscreen' whileInView='onscreen' viewport={{ once: true, amount: 0.3 }} className={`flex flex-col sm:py-16 py-6`}>
			<motion.div variants={centerVariants} className={`${layout.sectionInfo}  sm:px-16 px-6 `}>
				...
				<p className={`font-poppins font-normal text-[18px] leading-[30.8px] text-center text-white  mt-5`}>{product_what_manufature}</p>
			</motion.div>
