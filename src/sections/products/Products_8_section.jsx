	...
	return (
		<section id='product_8' className={`felx flex-col sm:py-16 py-6`}>
			<div className={`${layout.sectionInfo} mb-16 sm:px-16 px-6 `}>
				<h2 className={`font-poppins font-semibold xs:text-[48px] text-[40px] xs:leading-[76.8px] leading-[66.8px] md:w-full w-auto text-center text-white`}>Check out our products</h2>
			...
			<div className='sm:px-16 px-6 md:columns-4 sm:columns-3 columns-2 w-[100%] gap-[20px]'>
				{gallery.map((item, index) => (
					<div key={index} className='w-[100%] mb-[10px] rounded-lg bg-white break-inside-avoid box-shadow'>
