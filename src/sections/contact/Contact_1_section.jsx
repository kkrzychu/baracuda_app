...
const Contact_1_section = () => {
	...
	return (
		<section id='contact_1'  className={`flex md:flex-row flex-col sm:py-48 py-6`}>
			...
			<motion.div initial='offscreen' whileInView='onscreen' viewport={{ once: true, amount: 0.1 }}  variants={rightVariants} className={`${layout.sectionInfo} md:items-start sm:px-16 px-6 `}>
